...
#ifdef EM_DEBUG 
	typedef void * Xil_ExceptionHandler;
#endif
...
public:
	...
	void RegIRQ(DWORD irq, IUsingIrq* pobj, DWORD param = 0) const;
	void RegIRQ(DWORD irq, Xil_ExceptionHandler func, void* context = nullptr) const;
