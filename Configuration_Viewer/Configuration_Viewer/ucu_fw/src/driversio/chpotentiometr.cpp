...
ChPotentiometr::ChPotentiometr(CPattern* const pattern, UINT number) : IChannelIn(pattern)
{
	...
	registers_t[static_cast<UINT>(REGISTER_ID::rMAXLEVEL)] = {REGISTER_ID::rMAXLEVEL, rwConstant, rtDec, -200.0f, 200, 100.0f, false};
	registers_t[static_cast<UINT>(REGISTER_ID::rMINLEVEL)] = {REGISTER_ID::rMINLEVEL, rwConstant, rtDec, -200.0f, 200, 0.0f, false};
...
{
	registers_t[static_cast<UINT>(REGISTER_ID::rVALUE)].reg->SetValue(_channel->GetValue());
