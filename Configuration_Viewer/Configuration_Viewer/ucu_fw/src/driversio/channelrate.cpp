...
{
	_channel->registers_t[static_cast<UINT>(REGISTER_ID::rRATE)] = {REGISTER_ID::rRATE, rwVariable, rtFloat, MIN_FLOAT, MAX_FLOAT, 0.0f, false};
	_channel->registers_t[static_cast<UINT>(REGISTER_ID::rRATEBASE)] = {REGISTER_ID::rRATEBASE, rwConstant, rtDec, 1, 50, 1, false};
	_channel->registers_t[static_cast<UINT>(REGISTER_ID::rRATEREADY)] = {REGISTER_ID::rRATEREADY, rwVariable, rtDec, 0, 1, 0, false};
}
