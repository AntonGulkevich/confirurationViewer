...
ChLogicalIn::ChLogicalIn(CPattern* const pattern, UINT number) : IChannelIn(pattern)
{
	...
	registers_t[static_cast<UINT>(REGISTER_ID::rVALUE1)] = {REGISTER_ID::rVALUE1, rwVariable, rtFloat, MIN_FLOAT, MAX_FLOAT, 0.0f, false};
	registers_t[static_cast<UINT>(REGISTER_ID::rVALUE2)] = {REGISTER_ID::rVALUE2, rwVariable, rtFloat, MIN_FLOAT, MAX_FLOAT, 0.0f, false};
	registers_t[static_cast<UINT>(REGISTER_ID::rVALUE3)] = {REGISTER_ID::rVALUE3, rwVariable, rtFloat, MIN_FLOAT, MAX_FLOAT, 0.0f, false};
	...
	registers_t[static_cast<UINT>(REGISTER_ID::rDATAARRAY)] = {REGISTER_ID::rDATAARRAY, rwConstant, rtArray, 1, 200, 1, false},
