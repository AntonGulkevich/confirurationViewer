...
private:
	...
	UINT GetFifoCount() const
	{ return UCU_IORD_32DIRECT(_baseAddress, FIFO_COUNT_OFFSET); }
	UINT GetFifoStatus() const
	{ return UCU_IORD_32DIRECT(_baseAddress, FIFO_STATUS_OFFSET); }

	UINT GetTopWordTime() const
	{ return UCU_IORD_32DIRECT(_baseAddress, FIFO_TIME_OFFSET); }
	UINT GetTopWordValue() const
	{ return UCU_IORD_32DIRECT(_baseAddress, FIFO_VALUE_OFFSET); }
...
public:
	...
	explicit ArincIn(DWORD baseAddress);
	virtual ~ArincIn() {}
	...
	Arinc::Rate GetRate() const	{ return _controlRegister.rate; }
	...
	Arinc::ParityIn GetParity() const	{ return static_cast<Arinc::ParityIn>(_controlRegister.parity); }
	...
	UINT GetWordBufferCount() const	{ return _wordCount; }
