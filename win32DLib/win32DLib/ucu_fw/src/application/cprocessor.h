...
public:
	...
	explicit CProcessor(IChannelOut* channel);
	virtual ~CProcessor();	
    ...
    bool IsCalculated() const    { return calculated; } // Уже рассчитан
	...
	UINT ToBCD(UCU_FLOAT val, UINT fillBits) const;
